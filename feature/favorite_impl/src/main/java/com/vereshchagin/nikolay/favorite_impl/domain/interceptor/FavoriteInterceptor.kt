package com.vereshchagin.nikolay.favorite_impl.domain.interceptor

import com.vereshchagin.nikolay.favorite_impl.domain.usecase.GetFavoriteVacanciesUseCase
import com.vereshchagin.nikolay.favorite_impl.domain.usecase.RemoveFavoriteVacancyUseCase
