package com.vereshchagin.nikolay.hh_clone.search_impl.domain.interceptor

import com.vereshchagin.nikolay.hh_clone.search_impl.domain.usecase.GetMoreVacanciesCountUseCase
import com.vereshchagin.nikolay.hh_clone.search_impl.domain.usecase.GetRecommendationsUseCase
import com.vereshchagin.nikolay.hh_clone.search_impl.domain.usecase.GetRelativeVacanciesUseCase
import com.vereshchagin.nikolay.hh_clone.search_impl.domain.usecase.SetFavoriteVacancyUseCase
